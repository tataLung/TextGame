...
namespace TextGame
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("輸入操作 (0: 結束遊戲, 1: 顯示玩家狀態, 2:顯示怪物狀態 3:進入此回合戰鬥 4:復活怪物)");
                    ...
                    case '3':
                        ...
                        if(selectedMonster != null)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    if (game.HitMonster("你", selectedMonster))
                                    {
                                        ...
                                        int damage = game.PlayerDamage(selectedMonster, game.wizard);
